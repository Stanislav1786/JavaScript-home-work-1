...
console.log('Постфиксный инкримент:', i++);
console.log('Значение:', i);
console.log('Префиксный декримент:', --i);
console.log('Постфиксный декримент:', i--);
console.log('Значение:', i);
...
console.log('strRepelace:', strReplace);
 ...
 */
var myExp = 'верхний регистр';
var myExp1 = 'нижний регистр';
console.log(myExp.toUpperCase());
console.log(myExp1.toLowerCase());